...
public class Path implements MapObject {
	...
	public Path(ResourceManager mResourceManager, MapManager mMapManager, EObjectType objectType) {
	...
	public void draw(Application app) {
		if(mMapManager.getMapStatus() == MapManager.MapStatus.LoadingComplete){
